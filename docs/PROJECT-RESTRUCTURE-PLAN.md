...
- Add admin-controlled legacy Work redirect. Done 2026-06-07; redirect remains off by default and only redirects `/work/` when enabled plus migration status is safe.
...
Tasks:
- Implement theme options. Continued 2026-06-04; `kastalabs-core` now provides fallback WordPress options through Settings > Kastalabs Settings, including hero, homepage Services, homepage Portfolio, CTA, contact, footer, and analytics fields.
- Wire homepage copy to dynamic fields. Continued 2026-06-04; homepage hero, Services intro/pills/CTA, Featured Portfolio intro/CTA, and global CTA now read editable options.
- Wire services section to Service CPT. Done 2026-06-04; homepage and `/services/` read Service posts with fallback copy when content is empty.
- Wire featured portfolio to Portfolio CPT. Done 2026-06-04; homepage Featured Portfolio reads Portfolio posts and editable section copy.
...
- Add schema for Organization, Portfolio/CreativeWork, Articles. Continued 2026-06-05; theme now outputs Organization, WebSite, CreativeWork, and Article JSON-LD baseline, plus backend-managed SEO defaults, per-content SEO meta, OG/Twitter tags, robots baseline, and `/sitemap.xml` fallback.
- Validate contact form nonce/sanitization. Continued 2026-06-05; contact form uses nonce, honeypot, sanitization, lightweight IP throttling, private Inquiry storage, email delivery status, admin lead status workflow, follow-up date/internal notes, and CSV export.
- Harden public WordPress surface. Started 2026-06-05; baseline security now removes generator/pingback discovery, disables XML-RPC pingback methods, strips X-Pingback, and hides public REST user enumeration for anonymous visitors.
...
- Legacy Work redirects are controlled from Kastalabs Settings instead of being forced automatically.
