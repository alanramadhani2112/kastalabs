...
- Add schema for Organization, Portfolio/CreativeWork, Articles. Continued 2026-06-05; theme now outputs Organization, WebSite, CreativeWork, and Article JSON-LD baseline, plus backend-managed SEO defaults, per-content SEO meta, and OG/Twitter tags.
